...
public class FormularioAlumno extends javax.swing.JInternalFrame {
   ...
   * @param alumnoData
   */
  public FormularioAlumno(AlumnoData alumnoData) {
  ...
  private void initComponents() {
    ...
    if (chequeoDocumento()) {
      if (alumnoData.buscarAlumnoPorDni(Integer.parseInt(documento_text.getText())) != null) {
        try {
          Integer lo = Integer.parseInt(documento_text.getText());

          Alumno alumno = alumnoData.buscarAlumnoPorDni(Integer.parseInt(documento_text.getText()));
    ...
    if (chequeoExcepciones()) {
      ...
      if (boole == 0) {
        Alumno alumn = alumnoData.buscarAlumnoPorDni(Integer.parseInt(documento_text.getText()));
        ...
        alumnoData.modificarAlumno(alumn);
      }
    }
